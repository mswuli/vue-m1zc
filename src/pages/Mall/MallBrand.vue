...
<script>
	...
	import BrandList from "@/pages/Mall/components/BrandList";
	import BrandHeader from "@/pages/Mall/components/BrandHeader";
	import BrandInventor from "@/pages/Mall/components/BrandInventor";
	import BrandSeries from "@/pages/Mall/components/BrandSeries";
